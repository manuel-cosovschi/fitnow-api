...
const PUBLIC_COLS = 'id, name, email, role, provider_id, phone, bio, units, language, photo_url, pref_goal_km, pref_surface, fitness_level, fitness_goals, is_banned, created_at, updated_at';
...
export async function update(id, fields) {
  const allowed  = ['name', 'email', 'phone', 'bio', 'units', 'language', 'photo_url', 'pref_goal_km', 'pref_surface', 'fitness_level', 'fitness_goals'];
