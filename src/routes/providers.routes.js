...
router.put  ('/:id/hours', requireAuth, requireRole('admin','provider_admin'), ctrl.setHours);
router.post ('/:id/services', requireAuth, requireRole('admin','provider_admin'), ctrl.addService);
