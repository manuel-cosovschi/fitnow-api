...
import { createActivitySchema, updateActivitySchema, addSessionSchema, createPostSchema } from '../schemas/activity.schemas.js';
...
router.delete('/:id/posts/:postId',   requireAuth, requireRole('admin','provider_admin'),                    ctrl.deletePost);
